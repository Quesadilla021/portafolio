...
const freemaninit = (function() {
    ...
    var charIndex = 0;
    var textArray = ["Diseñador UI/UX ", " Desarrollador Web."];
...
setInterval(() => {
  ...
  slider.style.transform = `translateX(-${currentSlide * (200 + 20)}px)`;
}, 2000);

function alertaCorreo() {
    var input1 = document.getElementById("name").value;
    var input2 = document.getElementById("email").value;
    var input3 = document.getElementById("subject").value;
    var input4 = document.getElementById("message").value;
    ...
    if (input1 && input2 && input3 && input4) {
        if (input2.includes('@')) {
            ...
            Swal.fire(
                'Mensaje no enviado',
                'Por favor, ingrese un correo correctamente',
                'error'
              )
        }
    } else {
        Swal.fire(
            'Mensaje no enviado',
            'Por favor, complete los espacios solicitados',
            'error'
          )
    }
